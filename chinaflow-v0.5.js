(function () {
  ...
  function resolveChinaFlowConfigUrl() {
    ...
    try {
      ...
      if (
        ...
        override.trim() !== "" &&
        override.trim().startsWith("https://")
      ) {
      ...
      console.warn(
        "[ChinaFlow v0.5] Config override resolution failed; using default",
        error
      );

    }

    return DEFAULT_CHINAFLOW_CONFIG_URL;

  }

  const CHINAFLOW_CONFIG_URL =
    resolveChinaFlowConfigUrl();
  ...
  async function loadConfig() {
    ...
    try {
      ...
      console.error(
        "[ChinaFlow v0.5] Config load failed",
        error
      );
  ...
  function selectRule() {
    ...
    if (
      ...
      console.log(
        "[ChinaFlow v0.5] Non-content page — no auto routing"
      );
    ...
    console.log(
      "[ChinaFlow v0.5] China travel analysis:",
      {
    ...
    if (
      ...
      console.log(
        "[ChinaFlow v0.5] No China travel intent"
      );
    ...
    if (!offer) {
      ...
      console.warn(
        "[ChinaFlow v0.5] No offer available:",
        productIntent.product
      );
