(function () {
  ...
  const CHINAFLOW_CONFIG_URL =
    "https://raw.githubusercontent.com/an13501112545-create/chinaflow-script/main/config-event-v0.1-test.json";

  const DEFAULT_EVENT_SCHEMA_VERSION =
    "0.1";
  ...
  async function loadConfig() {
    ...
    try {
      ...
      console.error(
        "[ChinaFlow v0.4-test] Config load failed",
        error
      );
  ...
  function selectRule() {
    ...
    if (exactRule) {
      ...
      console.log(
        "[ChinaFlow v0.4-test] Exact rule:",
        exactRule.id
      );
      ...
      return createRoute(
        exactRule,
        {
          ...
          routing_reason:
            nullableValue(exactRule.routing_reason),
          china_intent:
            null,
          china_intent_score:
            null,
    ...
    if (
      ...
      console.log(
        "[ChinaFlow v0.4-test] Non-content page — no auto routing"
      );
    ...
    console.log(
      "[ChinaFlow v0.4-test] China travel analysis:",
      {
    ...
    if (
      ...
      console.log(
        "[ChinaFlow v0.4-test] No China travel intent"
      );
    ...
    console.log(
      "[ChinaFlow v0.4-test] Product intent:",
      productIntent
    );
    ...
    if (!offer) {
      ...
      console.warn(
        "[ChinaFlow v0.4-test] No offer available:",
        productIntent.product
      );
    ...
    console.log(
      "[ChinaFlow v0.4-test] Smart route:",
      productIntent.product,
      "→",
      offer.id
    );
  ...
  new MutationObserver(
    function () {
      ...
      if (
         ...
         * but its test analytics stops with the old page context.
         */
        cleanupActiveAnalytics();
